...
Original file is located at
    https://colab.research.google.com/drive/1594Ilx5pXdpoewgFFzVrHTYzdyj2ilpe
"""
# 'data/intents/intents.json' = 'data/intents/intents.json'
MODEL_OUTPUT_PATH = "data/model/data.pth"
...
with open('data/intents/intents.json','r') as f:
    intents = json.load(f)
